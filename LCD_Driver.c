...
// Create a function like this to display start up screen
...
//	}
	...
	HAL_Delay(1500);
	LCD_DisplayChar(80,160,'H');
	LCD_DisplayChar(95,160,'e');
	LCD_DisplayChar(105,160,'l');
	LCD_DisplayChar(115,160,'l');
	LCD_DisplayChar(125,160,'o');

	LCD_DisplayChar(80,180,'W');
	LCD_DisplayChar(95,180,'o');
	LCD_DisplayChar(105,180,'r');
	LCD_DisplayChar(115,180,'l');
	LCD_DisplayChar(125,180,'d');

	LCD_Draw_Vertical_Line(70,150,40,LCD_COLOR_MAGENTA);
	HAL_Delay(1500);
	LCD_Draw_Vertical_Line(135,150,40,LCD_COLOR_MAGENTA);
	HAL_Delay(1500);
	LCD_Draw_Horizontal_Line(70, 150, 65, LCD_COLOR_MAGENTA);
	HAL_Delay(1500);
	LCD_Draw_Horizontal_Line(70, 190, 65, LCD_COLOR_MAGENTA);
	HAL_Delay(1500);
